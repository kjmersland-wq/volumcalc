  ...
  head: () => ({
    meta: [
      { title: "Contact VolumCalc — talk to us about volume estimates" },
      {
        name: "description",
        content:
          "Get in touch with the VolumCalc team about photo-based volume estimates, pricing for movers, demos or support. We reply within one business day.",
      },
      { property: "og:title", content: "Contact VolumCalc" },
      {
        property: "og:description",
        content: "Questions about photo-based volume estimates, pricing or a demo? Send us a message.",
      },
