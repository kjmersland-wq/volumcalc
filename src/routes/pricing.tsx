...
function Pricing() {
  ...
  const pricingCopy = {
    ...
    businessFeatures: {
      ...
      sv: ["Alla kärnfunktioner", "Egen logotyp och egna färger", "Pris per m³ och offerter", "PDF-rapport"],
      da: ["Alle kernefunktioner", "Eget logo og egne farver", "Pris pr. m³ og tilbud", "PDF-rapport"],
      fi: ["Kaikki perusominaisuudet", "Oma logo ja omat värit", "Hinta per m³ ja tarjoukset", "PDF-raportti"],
      de: ["Alle Kernfunktionen", "Eigenes Logo und eigene Farben", "Preis pro m³ und Angebote", "PDF-Bericht"],
      nl: ["Alle basisfuncties", "Je eigen logo en kleuren", "Prijs per m³ en offertes", "PDF-rapport"],
      fr: ["Toutes les fonctions essentielles", "Votre logo et vos couleurs", "Tarif au m³ et devis", "Rapport PDF"],
      pl: ["Wszystkie funkcje podstawowe", "Własne logo i kolory", "Cena za m³ i oferty", "Raport PDF"],
      es: ["Todas las funciones principales", "Tu logotipo y tus colores", "Tarifa por m³ y presupuestos", "Informe PDF"],
      it: ["Tutte le funzioni essenziali", "Logo e colori del tuo marchio", "Tariffa per m³ e preventivi", "Report PDF"],
      pt: ["Todas as funcionalidades essenciais", "O seu logótipo e as suas cores", "Preço por m³ e orçamentos", "Relatório PDF"],
    }[lang] ?? ["All core features", "Your logo and colours", "Rate per m³ and quotes", "PDF report"],
    enterprisePrice: {
      no: "Kontakt oss",
      en: "Talk to us",
      sv: "Prata med oss",
    ...
    enterpriseFeatures: {
      ...
      en: ["Everything in Business", "Multiple branches", "API and integrations", "Dedicated contact"],
      ...
      fi: ["Kaikki Business-paketista", "Useita toimipisteitä", "API ja integraatiot", "Oma yhteyshenkilö"],
      de: ["Alles aus Business", "Mehrere Standorte", "API und Integrationen", "Persönliche Ansprechperson"],
      nl: ["Alles uit Business", "Meerdere vestigingen", "API en integraties", "Vaste contactpersoon"],
      fr: ["Tout le contenu de Business", "Plusieurs agences", "API et intégrations", "Interlocuteur dédié"],
      pl: ["Wszystko z pakietu Business", "Wiele oddziałów", "API i integracje", "Dedykowany opiekun"],
      es: ["Todo lo de Business", "Varias sucursales", "API e integraciones", "Persona de contacto dedicada"],
      it: ["Tutto ciò che è incluso in Business", "Più sedi", "API e integrazioni", "Referente dedicato"],
      pt: ["Tudo o que está no Business", "Várias filiais", "API e integrações", "Contacto dedicado"],
    }[lang] ?? ["Everything in Business", "Multiple branches", "API and integrations", "Dedicated contact"],
    singleName: {
      no: "Én beregning",
      en: "Single estimate",
      sv: "1 beräkning",
